...
// ═══════════════════════════════════════════════════════════════
//  STUDIO_CONFIG — Ashland Hot Yoga, Ashland
// ═══════════════════════════════════════════════════════════════
const STUDIO_CONFIG = {
  name: "ASHLAND",
  subtitle: "HOT YOGA",
  tagline: "Feel alive.",
  logoMark: "AH",
  description: "Southern Oregon's beloved hot yoga studio. Wood-burning stove heat, eucalyptus towels, and a community that makes you feel alive.",
  heroLine1: "FEEL",
  heroLine2: "ALIVE",

  address: { street: "2455 Siskiyou Blvd", city: "Ashland", state: "OR", zip: "97520" },
  phone: "(541) 631-9049",
  email: "info@ashlandhotyoga.com",
  neighborhood: "Siskiyou Blvd, Ashland",
  website: "https://ashlandhotyoga.com",
  social: { instagram: "@ashlandhotyoga" },

  theme: {
    accent:     { h: 28, s: 75, l: 50 },   // Warm amber/gold
    accentAlt:  { h: 155, s: 40, l: 45 },    // Soft violet
    warning:    { h: 8, s: 70, l: 50 },     // Burnt orange
    primary:    { h: 25, s: 20, l: 11 },     // Deep midnight blue
    surface:    { h: 30, s: 12, l: 97 },     // Cool white
    surfaceDim: { h: 28, s: 10, l: 93 },     // Soft gray
  },
...
const STUDIO_IMAGES = {
  ...
  teachers: {
    ...
    hillary: "https://ashlandhotyoga.com/wp-content/uploads/2024/05/WhatsApp-Image-2024-05-25-at-00.51.22_85fb30d2-1024x1024.jpg",
    kaitlyn: "https://ashlandhotyoga.com/wp-content/uploads/2024/05/6F8D9651-AEC8-440A-A761-BA1DEC8A3FC0-1024x1024.jpeg",
    sandy: "https://ashlandhotyoga.com/wp-content/uploads/2024/05/11286FC2-7891-47E0-AA59-F2B62846B941.jpeg",
    lola: "https://ashlandhotyoga.com/wp-content/uploads/2024/05/045B5171-81EB-49A1-B7B0-7E1E214E5BB9-1024x1024.jpeg",
    wolf: "https://ashlandhotyoga.com/wp-content/uploads/2024/05/035E0312-8FA9-4810-9069-AFDB3978FEB7-1024x1024.jpeg",
...
// ═══════════════════════════════════════════════════════════════
//  MOCK DATA — Ashland Hot Yoga content
// ═══════════════════════════════════════════════════════════════
const TEACHERS = [
  { photo: STUDIO_IMAGES.teachers.christine, id: "t1", firstName: "Christine", lastName: "Boyer", role: "Lead Teacher", certs: ["Bikram Certified", "Inferno Hot Pilates", "Ayurvedic Practitioner", "200hr Vinyasa"], specialties: ["Hot Yoga", "Inferno Pilates", "Vinyasa"], yearsTeaching: 28, bio: "Christine fell in love with yoga in 1996 while living and practicing in London, England. She loves teaching and helping others live vibrant, healthy lives. Her background includes Bikram, Inferno Hot Pilates, Ayurvedic practice, Ashtanga, and Sivananda Yoga. She co-founded Aradia Fitness." },
  { photo: STUDIO_IMAGES.teachers.crystal, id: "t2", firstName: "Crystal", lastName: "V.", role: "Teacher & Professor", certs: ["MS Kinesiology", "BFA Dance", "Multiple Certifications"], specialties: ["Hot Yoga", "Breathwork", "Yin Yang"], yearsTeaching: 15, bio: "Crystal is a full-time faculty member in Health and Exercise Science at Southern Oregon University. Her journey of healing paralleled her study of yoga — from academia to the Himalayas. She's taught at Wanderlust, Prana Fest, and the Oregon Country Fair, bringing scientific knowledge and lived experience to every class." },
  { photo: STUDIO_IMAGES.teachers.kaitlyn, id: "t3", firstName: "Kaitlyn", lastName: "M.", role: "Teacher", certs: ["RYT-200"], specialties: ["Hot Yoga", "Yin Yang", "Flow"], yearsTeaching: 6, bio: "Kaitlyn is a studio favorite — students describe her as a fantastic instructor who holds space so thoughtfully. She creates an immediately welcoming, comfortable environment where you feel at ease from the first moment. Her Yin Yang classes are legendary." },
  { photo: STUDIO_IMAGES.teachers.sandy, id: "t4", firstName: "Sandy", lastName: "R.", role: "Teacher", certs: ["RYT-200"], specialties: ["Hot Yoga", "Yin", "Flow"], yearsTeaching: 8, bio: "Sandy is one of the most beloved teachers at Ashland Hot Yoga. Students rave about the consistent practice she inspires — many have been practicing daily for over two years. Her guidance makes you feel alive, and her classes are the perfect start or end to any day." },
  { photo: STUDIO_IMAGES.teachers.hillary, id: "t5", firstName: "Hillary", lastName: "T.", role: "Teacher", certs: ["RYT-200"], specialties: ["Yin Yang", "Hot Yoga", "Restorative"], yearsTeaching: 5, bio: "Hillary's Yin Yang classes are a full class experience — she's great at connecting with everyone and giving excellent cues. She provides info on the benefits of each movement and creates a welcoming, inclusive space where all levels feel supported." },
  { photo: STUDIO_IMAGES.teachers.lola, id: "t6", firstName: "Lola", lastName: "K.", role: "Teacher", certs: ["RYT-200", "Children's Yoga"], specialties: ["Hot Yoga", "Kids Yoga", "Vinyasa"], yearsTeaching: 10, bio: "Lola found her love for yoga in New York City in 2003. She completed her 200hr in Ashtanga and Vinyasa with Jonah Kest. She also opened a local preschool focused on mindfulness, yoga, and art. She brings playfulness and depth to every class." },
  { photo: STUDIO_IMAGES.teachers.wolf, id: "t7", firstName: "Wolf", lastName: "S.", role: "Teacher", certs: ["RYT-200"], specialties: ["Hot Yoga", "Flow"], yearsTeaching: 4, bio: "Wolf brings a grounded, earthy presence to every class. His teaching style encourages you to listen deeply to your body while still finding your edge. A favorite among members looking for a challenging yet supportive practice." },
  { photo: STUDIO_IMAGES.teachers.nicole, id: "t8", firstName: "Nicole", lastName: "B.", role: "Teacher", certs: ["RYT-200"], specialties: ["Hot Yoga", "Yin", "Flow"], yearsTeaching: 5, bio: "Nicole's classes offer options for all levels — easier and harder alternatives for every movement. Her encouraging energy and thoughtful modifications make her classes accessible to beginners while still challenging seasoned practitioners." },
];

const TODAYS_FOCUS = {
  id: "focus-today", date: today, name: "Hot Yoga", type: "HOT",
  style: "Hot Yoga", temp: "Wood Stove Heated", duration: 75,
  description: "Our signature hot yoga class in a 100-year-old building heated by a real wood-burning stove. Dynamic sequences building strength, flexibility, and cardiovascular health. Finish with a chilled eucalyptus towel.",
  intention: "Find your fire within. Breathe. Sweat. Flow.",
  teacherTip: "It's normal to feel dizzy your first time — just drink water, lie down, and rejoin when ready. What the teacher offers is a suggestion. Do what feels right for your body.",
  playlist: "Teacher's choice — no two classes are the same",
};

const PAST_PRACTICES = [
  { id: "p-y1", date: offsetDate(-1), name: "Yin Yang", type: "YINYANG", style: "Yin Yang", temp: "Warm", duration: 75, description: "Move through a Yang flow to warm up and build core strength in the first half. Settle into long Yin holds for deep release in the second half. The combination creates space and integrity in the joints.", intention: "Balance the fire and stillness within you.", teacherTip: "The Yang half energizes. The Yin half heals. Both are essential." },
  { id: "p-y2", date: offsetDate(-2), name: "Inferno Hot Pilates", type: "PILATES", style: "Inferno", temp: "Heated", duration: 60, description: "A high-intensity, low-impact workout that builds core strength, endurance, and sculpts lean muscle. Set to driving music in the heated room. You will be sore tomorrow — in the best way.", intention: "Embrace the burn. That's where the transformation lives.", teacherTip: "Everything is modifiable. Listen to your body and take breaks as needed." },
  { id: "p-y3", date: offsetDate(-3), name: "Hot Flow", type: "FLOW", style: "Hot Flow", temp: "Heated", duration: 60, description: "A creative, teacher-led vinyasa flow in the heated room. Every class is different — sun salutations, inversions, arm balances, and deep stretching woven into a unique sequence.", intention: "Flow is finding freedom in the movement." },
];

const UPCOMING_PRACTICE = { id: "p-tmrw", date: offsetDate(1), name: "Yin", type: "YIN", style: "Yin", temp: "Warm", duration: 60, description: "Long-held, passive poses targeting deep connective tissue. A meditative practice of surrender and release in our cozy, wood-stove heated studio.", intention: "In stillness, we find what movement cannot give us.", teacherTip: "Bring an extra layer. Let gravity do the work. If you're muscling through, soften." };

const CLASSES_TODAY = [
  { id: "cl1", time: "06:15", type: "Hot Yoga", coach: "Christine Boyer", capacity: 30, registered: 24, waitlist: 0 },
  { id: "cl2", time: "08:00", type: "Hot Flow", coach: "Sandy R.", capacity: 30, registered: 28, waitlist: 0 },
  { id: "cl3", time: "09:30", type: "Yin Yang", coach: "Hillary T.", capacity: 30, registered: 30, waitlist: 2 },
  { id: "cl4", time: "11:00", type: "Hot Yoga", coach: "Kaitlyn M.", capacity: 30, registered: 22, waitlist: 0 },
  { id: "cl5", time: "12:30", type: "Inferno Hot Pilates", coach: "Christine Boyer", capacity: 25, registered: 20, waitlist: 0 },
  { id: "cl6", time: "16:30", type: "Hot Yoga", coach: "Crystal V.", capacity: 30, registered: 28, waitlist: 0 },
  { id: "cl7", time: "18:00", type: "Yin", coach: "Sandy R.", capacity: 25, registered: 18, waitlist: 0 },
];

const WEEKLY_SCHEDULE = [
  { day: "Monday", classes: [{ time: "06:15", type: "Hot Yoga", coach: "Christine" }, { time: "08:00", type: "Hot Flow", coach: "Sandy" }, { time: "09:30", type: "Yin Yang", coach: "Hillary" }, { time: "11:00", type: "Hot Yoga", coach: "Kaitlyn" }, { time: "12:30", type: "Inferno Pilates", coach: "Christine" }, { time: "16:30", type: "Hot Yoga", coach: "Crystal" }, { time: "18:00", type: "Yin", coach: "Sandy" }] },
  { day: "Tuesday", classes: [{ time: "07:00", type: "Hot Yoga", coach: "Kaitlyn" }, { time: "09:00", type: "Hot Flow", coach: "Lola" }, { time: "10:30", type: "Yin Yang", coach: "Hillary" }, { time: "12:00", type: "Hot Yoga", coach: "Wolf" }, { time: "16:00", type: "Hot Yoga", coach: "Nicole" }, { time: "17:30", type: "Hot Flow", coach: "Sandy" }] },
  { day: "Wednesday", classes: [{ time: "06:15", type: "Hot Yoga", coach: "Christine" }, { time: "08:00", type: "Inferno Pilates", coach: "Christine" }, { time: "09:30", type: "Hot Yoga", coach: "Crystal" }, { time: "11:00", type: "Yin Yang", coach: "Hillary" }, { time: "16:30", type: "Hot Flow", coach: "Kaitlyn" }, { time: "18:00", type: "Hot Yoga", coach: "Sandy" }] },
  { day: "Thursday", classes: [{ time: "07:00", type: "Hot Yoga", coach: "Sandy" }, { time: "09:00", type: "Hot Flow", coach: "Lola" }, { time: "10:30", type: "Hot Yoga", coach: "Wolf" }, { time: "12:00", type: "Yin", coach: "Nicole" }, { time: "16:00", type: "Hot Yoga", coach: "Kaitlyn" }, { time: "17:30", type: "Hot Flow", coach: "Crystal" }] },
  { day: "Friday", classes: [{ time: "06:15", type: "Hot Yoga", coach: "Christine" }, { time: "08:00", type: "Hot Flow", coach: "Sandy" }, { time: "09:30", type: "Yin Yang", coach: "Hillary" }, { time: "11:00", type: "Hot Yoga", coach: "Kaitlyn" }, { time: "16:30", type: "Hot Yoga", coach: "Crystal" }] },
  { day: "Saturday", classes: [{ time: "08:30", type: "Hot Yoga", coach: "Christine" }, { time: "10:00", type: "Hot Flow", coach: "Kaitlyn" }, { time: "11:30", type: "Yin Yang", coach: "Hillary" }, { time: "14:00", type: "Hot Yoga", coach: "Sandy" }, { time: "16:00", type: "Yin", coach: "Nicole" }] },
  { day: "Sunday", classes: [{ time: "08:30", type: "Hot Yoga", coach: "Sandy" }, { time: "10:00", type: "Hot Flow", coach: "Crystal" }, { time: "11:30", type: "Yin Yang", coach: "Hillary" }, { time: "14:00", type: "Hot Yoga", coach: "Wolf" }, { time: "16:00", type: "Restorative", coach: "Sandy" }, { time: "18:00", type: "Hot Yoga", coach: "Kaitlyn" }] },
];

const COMMUNITY_FEED = [
  { id: "cf1", user: "Maria L.", milestone: "365-Day Streak", message: "I've been attending daily for over two years. My physical and mental well-being have seen significant improvements. This place is truly transformative.", date: today, celebrations: 68 },
  { id: "cf2", user: "Jake P.", milestone: "30-Day Streak", message: "Kaitlyn and Sandy are my fav! The wood stove heat makes me feel so ALIVE. Best way to start or end the day.", date: today, celebrations: 32 },
  { id: "cf3", user: "Emma W.", milestone: "First Hot Yoga!", message: "My daughter and I visited from Bend and were so well taken care of — mat, towel, shower. The eucalyptus cold towel at the end was worth the entire cost!", date: offsetDate(-1), celebrations: 44 },
  { id: "cf4", user: "Sam R.", milestone: "100 Classes", message: "I love this studio for all the classes but especially the variety and times. Solid instruction for safety and injury prevention. Thank you Ashland Hot Yoga!", date: offsetDate(-1), celebrations: 38 },
];
...
const MILESTONE_BADGES = {
  ...
  "365 Days": { icon: Star, color: "#3b82f6" },
  "First Inferno": { icon: Zap, color: "#8b5cf6" },
  "1 Year Member": { icon: Award, color: T.success },
};

const EVENTS = [
  { id: "ev1", name: "Yoga Mala", date: "2026-05-10", startTime: "08:00", type: "Special Event", description: "108 sun salutations — a sacred practice of devotion and endurance. Our annual Yoga Mala brings the community together for a powerful collective experience in our century-old studio.", fee: 25, maxParticipants: 30, registered: 18, status: "Registration Open" },
  { id: "ev2", name: "200-Hour Teacher Training", date: "2026-06-15", startTime: "09:00", type: "Training", description: "A comprehensive 200-hour Yoga Alliance certified teacher training with Ashland Hot Yoga and Practical Radiance. Learn to teach with integrity, knowledge, and heart. $2,950 early bird / $3,250 regular.", fee: 2950, maxParticipants: 16, registered: 7, status: "Registration Open" },
  { id: "ev3", name: "Yin Yang Workshop with Hillary", date: "2026-04-26", startTime: "13:00", type: "Workshop", description: "A 2-hour deep dive into the balance of Yang fire and Yin stillness. Explore the Taoist philosophy behind the practice and learn techniques to bring both energies into your daily life.", fee: 35, maxParticipants: 25, registered: 16, status: "Registration Open" },
  { id: "ev4", name: "Live Music Hot Flow", date: "2026-05-02", startTime: "18:00", type: "Special Class", description: "Janapriyan Levine brings live music to the heated room. Flow through a dynamic sequence accompanied by ambient, soulful live sound in our 100-year-old studio.", fee: 30, maxParticipants: 30, registered: 22, status: "Registration Open" },
];

const MEMBERSHIP_TIERS = [
  { id: "m1", name: "Drop-In", type: "drop-in", price: 25, period: "per class", features: ["Single class access", "30-day expiration", "Mat & towel rental: $2 each"], popular: false },
  { id: "m2", name: "5 Class Pass", type: "pack", price: 100, period: "5 classes", features: ["$20 per class", "Valid for 4 months", "Shareable with a friend"], popular: false },
  { id: "m3", name: "10 Class Pass", type: "pack", price: 180, period: "10 classes", features: ["$18 per class", "Valid for 6 months", "Shareable with a friend"], popular: false },
  { id: "m4", name: "Spark", type: "monthly", price: 85, period: "/month", features: ["5 classes per month", "3-month commitment", "Great for once a week", "Extra classes: $17 each"], popular: false },
  { id: "m5", name: "Blaze", type: "monthly", price: 120, period: "/month", features: ["8 classes per month", "3-month commitment", "Great for twice a week", "Extra classes: $15 each"], popular: false },
  { id: "m6", name: "Inferno", type: "unlimited", price: 150, period: "/month", features: ["Unlimited classes", "3-month commitment", "Best value for 3-4x per week", "Eucalyptus towels every visit", "The full fire experience"], popular: true },
];

const ANNOUNCEMENTS = [
  { id: "a1", title: "New Student Intro: 2 Weeks for $50!", message: "Unlimited classes for 14 days. Brand new to Ashland Hot Yoga? This is your invitation to find your fire within.", type: "celebration", pinned: true },
  { id: "a2", title: "100 Years of Heat", message: "Our studio operates in a century-old building that's been home to hot yoga for over 20 years. Come feel the difference of real wood stove heat.", type: "info", pinned: false },
];

const MEMBERS_DATA = [
  { id: "mem1", name: "Maria Lopez", email: "maria@email.com", membership: "Inferno", status: "active", joined: "2022-01-01", checkIns: 856, lastVisit: today },
  { id: "mem2", name: "Jake Peterson", email: "jake@email.com", membership: "Inferno", status: "active", joined: "2023-06-15", checkIns: 342, lastVisit: offsetDate(-1) },
  { id: "mem3", name: "Emma Wilson", email: "emma@email.com", membership: "Blaze", status: "active", joined: "2025-09-01", checkIns: 52, lastVisit: offsetDate(-2) },
  { id: "mem4", name: "Sam Reeves", email: "sam@email.com", membership: "Inferno", status: "active", joined: "2025-03-24", checkIns: 148, lastVisit: today },
  { id: "mem5", name: "Taylor Kim", email: "taylor@email.com", membership: "Inferno", status: "frozen", joined: "2024-07-01", checkIns: 98, lastVisit: offsetDate(-30) },
  { id: "mem6", name: "Riley Chen", email: "riley@email.com", membership: "5 Class Pass", status: "active", joined: "2026-02-01", checkIns: 3, lastVisit: offsetDate(-5) },
  { id: "mem7", name: "Jordan Torres", email: "jordan@email.com", membership: "Inferno", status: "active", joined: "2023-11-01", checkIns: 224, lastVisit: today },
  { id: "mem8", name: "Casey Park", email: "casey@email.com", membership: "Spark", status: "active", joined: "2025-12-10", checkIns: 16, lastVisit: offsetDate(-3) },
];

const ADMIN_METRICS = {
  activeMembers: 172, memberChange: 10,
  todayCheckIns: 68, weekCheckIns: 398,
  monthlyRevenue: 21800, revenueChange: 8.4,
  workshopRevenue: 2800,
};

const ADMIN_CHARTS = {
  attendance: [
    { day: "Mon", total: 72, avg: 10 }, { day: "Tue", total: 58, avg: 10 },
    { day: "Wed", total: 66, avg: 11 }, { day: "Thu", total: 56, avg: 9 },
    { day: "Fri", total: 54, avg: 11 }, { day: "Sat", total: 52, avg: 10 },
    { day: "Sun", total: 48, avg: 8 },
  ],
  revenue: [
    { month: "Sep", revenue: 17800 }, { month: "Oct", revenue: 18600 },
    { month: "Nov", revenue: 19200 }, { month: "Dec", revenue: 18400 },
    { month: "Jan", revenue: 20400 }, { month: "Feb", revenue: 21200 },
    { month: "Mar", revenue: 21800 },
  ],
  classPopularity: [
    { name: "6:15 AM", pct: 80 }, { name: "8:00 AM", pct: 94 },
    { name: "9:30 AM", pct: 100 }, { name: "11:00 AM", pct: 74 },
    { name: "12:30 PM", pct: 80 }, { name: "4:30 PM", pct: 94 },
    { name: "6:00 PM", pct: 72 },
  ],
  membershipBreakdown: [
    { name: "Inferno", value: 72, color: T.accent },
    { name: "Blaze", value: 38, color: T.success },
    { name: "Spark", value: 24, color: T.warning },
    { name: "Class Packs", value: 26, color: T.textMuted },
    { name: "Drop-In", value: 12, color: "#94a3b8" },
  ],
};
...
function HomePage() {
  ...
  return (
    <div className="pb-6">
      {/* Hero */}
      <section style={{ position: "relative", overflow: "hidden", color: "#fff", padding: "40px 22px 32px", minHeight: 300, marginBottom: 16 }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: `url(${STUDIO_IMAGES.heroYouBelongHere})`, backgroundSize: "cover", backgroundPosition: "center", filter: "brightness(0.75)" }} />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, rgba(0,0,0,0.12) 0%, rgba(0,0,0,0.04) 40%, rgba(0,0,0,0.35) 100%)" }} />
        <div style={{ position: "absolute", top: 16, right: 20, fontSize: 80, opacity: 0.1, lineHeight: 1, zIndex: 1 }}>AH</div>
...
function CommunityPage() {
  ...
  return (
    <div style={{ padding: "0 16px" }}>
      <PageHero title="Community" subtitle="Celebrate each other's wins at Ashland Hot Yoga" image={STUDIO_IMAGES.about} />
...
function TeachersPage() {
  ...
  return (
    <div style={{ padding: "0 16px" }}>
      <PageHero title="Teachers" subtitle="Meet the Ashland Hot Yoga teaching team" image={STUDIO_IMAGES.teacherTraining} />
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          return (
            <div key={teacher.id} onClick={() => setExpandedTeacher(expanded ? null : teacher.id)} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, overflow: "hidden", cursor: "pointer", transition: "all 0.2s" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 14, padding: "16px 18px" }}>
                ...
                <div style={{ width: 56, height: 56, borderRadius: 14, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: teacher.photo ? "none" : "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Playfair Display', serif", fontSize: 22, color: "#fff", flexShrink: 0, fontWeight: 600 }}>
...
function MembershipPage() {
  return (
    <div style={{ padding: "0 16px" }}>
      <PageHero title="Membership" subtitle="Find your fire — Spark, Blaze, or Inferno" image={STUDIO_IMAGES.pricing} />
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: T.bgCard, border: `1px solid ${tier.popular ? T.accent : T.border}`, borderRadius: 14, padding: "20px 18px", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
              {tier.name === "Inferno" ? <Flame size={20} color={T.accent} /> : tier.name === "Blaze" ? <Sun size={20} color={T.accent} /> : tier.name === "Spark" ? <Zap size={20} color={T.accent} /> : <Moon size={20} color={T.accent} />}
              <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, margin: 0, color: T.text }}>{tier.name}</h3>
            </div>
...
function EventsPage() {
  return (
    <div style={{ padding: "0 16px" }}>
      <PageHero title="Events" subtitle="Yoga Mala, teacher training, and workshops" image={STUDIO_IMAGES.events} />
      {EVENTS.map(ev => (
...
function GuestPassPage() {
  ...
  return (
    <div style={{ padding: "0 16px" }}>
      <PageHero title="Guest Passes" subtitle="Bring a friend to Ashland" image={STUDIO_IMAGES.welcomeEntrance} />
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 20 }}>
        <div style={{ background: T.accentGhost, border: `1px solid ${T.accentBorder}`, borderRadius: 12, padding: "16px 14px", textAlign: "center" }}>
          ...
          <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, fontWeight: 700, color: T.text }}>{passesRemaining}</div>
        ...
        <div style={{ background: T.successGhost, border: `1px solid ${T.successBorder}`, borderRadius: 12, padding: "16px 14px", textAlign: "center" }}>
          ...
          <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, fontWeight: 700, color: T.text }}>{passesUsed}</div>
      ...
      <div style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, padding: 20 }}>
        <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 20, margin: "0 0 14px" }}>Send a Guest Pass</h3>
        <InputField label="Friend's Name" placeholder="Their name" />
        <InputField label="Their Email" placeholder="friend@email.com" />
        <button onClick={() => { setSent(true); setTimeout(() => setSent(false), 2500); }} style={{ width: "100%", padding: "12px 0", borderRadius: 8, border: "none", fontWeight: 700, cursor: "pointer", background: T.accent, color: "#fff", fontFamily: "'Playfair Display', serif", fontSize: 17, marginTop: 8, display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
...
function AdminDashboard() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div>
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: "#1a1e2e", margin: 0 }}>Dashboard</h1>
        <p style={{ fontSize: 13, color: "#64748b", margin: "4px 0 0" }}>Welcome back. Here's what's happening at {STUDIO_CONFIG.name}.</p>
      </div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 14 }}>
        {metrics.map((m, i) => (
          <div key={i} style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
            ...
            <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 30, color: "#1a1e2e", fontWeight: 700 }}>{m.value}</div>
            ...
            <p style={{ fontSize: 13, color: "#64748b", margin: "6px 0 0" }}>{m.label}</p>
          </div>
        ))}
      </div>
          ...
          <div style={{ height: 220 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={ADMIN_CHARTS.attendance}>
                ...
                <Tooltip contentStyle={{ backgroundColor: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1e2e" }} />
          ...
          <div style={{ height: 220 }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={ADMIN_CHARTS.revenue}>
                ...
                <Tooltip contentStyle={{ backgroundColor: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1e2e" }} formatter={(v) => [`$${v.toLocaleString()}`, "Revenue"]} />
                <defs>
          ...
          <div style={{ height: 210 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={ADMIN_CHARTS.classPopularity} layout="vertical">
                ...
                <Tooltip contentStyle={{ backgroundColor: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1e2e" }} formatter={v => [`${v}%`, "Fill Rate"]} />
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: "#1a1e2e", margin: 0 }}>Members</h1>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          <thead>
            <tr style={{ borderBottom: "1px solid #e5e7eb" }}>
              {["Member", "Plan", "Status", "Check-ins", "Last Visit", "Actions"].map(h => (
          ...
          <tbody>
            {filtered.map(m => (
              <tr key={m.id} style={{ borderBottom: "1px solid #e5e7eb" }}>
                <td style={{ padding: "12px 16px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <div>
                      ...
                      <p style={{ color: "#64748b", fontSize: 11, margin: "1px 0 0" }}>{m.email}</p>
                    </div>
                  </div>
                </td>
                <td style={{ padding: "12px 16px", color: "#1a1e2e" }}>{m.membership}</td>
                <td style={{ padding: "12px 16px" }}>
                ...
                <td style={{ padding: "12px 16px", color: "#64748b", fontFamily: "monospace" }}>{m.checkIns}</td>
                <td style={{ padding: "12px 16px", color: "#64748b" }}>{formatDateShort(m.lastVisit)}</td>
                <td style={{ padding: "12px 16px" }}>
                  <div style={{ display: "flex", gap: 6 }}>
                    <button style={{ padding: "4px 8px", borderRadius: 4, border: "1px solid #e5e7eb", background: "transparent", color: "#1a1e2e", fontSize: 11, fontWeight: 600, cursor: "pointer" }}>Edit</button>
                    <button style={{ padding: "4px 8px", borderRadius: 4, border: "1px solid #e5e7eb", background: "transparent", color: "#f87171", fontSize: 11, fontWeight: 600, cursor: "pointer" }}>Delete</button>
                  </div>
                </td>
              </tr>
            ))}
...
function AdminSchedulePage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: "#1a1e2e", margin: 0 }}>Schedule Management</h1>
        <button style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>
      ...
      <div style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, overflow: "hidden" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          <thead>
            <tr style={{ borderBottom: "1px solid #e5e7eb" }}>
              {["Time", "Class", "Teacher", "Capacity", "Registered", "Status", "Actions"].map(h => (
                <th key={h} style={{ padding: "12px 16px", textAlign: "left", color: "#64748b", fontWeight: 600, fontSize: 11, textTransform: "uppercase", letterSpacing: "0.05em" }}>{h}</th>
              ))}
            </tr>
          </thead>
          <tbody>
            {CLASSES_TODAY.map(c => (
              <tr key={c.id} style={{ borderBottom: "1px solid #e5e7eb" }}>
                ...
                <td style={{ padding: "12px 16px", color: "#1a1e2e", fontWeight: 600 }}>{c.type}</td>
                <td style={{ padding: "12px 16px", color: "#1a1e2e" }}>{c.coach}</td>
                <td style={{ padding: "12px 16px", color: "#64748b" }}>{c.capacity}</td>
                <td style={{ padding: "12px 16px" }}>
...
function AdminTeachersPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: "#1a1e2e", margin: 0 }}>Teachers</h1>
        <button style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>
        ...
        {TEACHERS.map(teacher => (
          <div key={teacher.id} style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginBottom: 10 }}>
              {teacher.certs.map(c => (
                <span key={c} style={{ fontSize: 10, fontWeight: 600, padding: "2px 6px", borderRadius: 4, background: "#e5e7eb", color: "#64748b" }}>{c}</span>
              ))}
            </div>
            <div style={{ display: "flex", gap: 6 }}>
              <button style={{ flex: 1, padding: "8px 0", borderRadius: 6, border: "1px solid #e5e7eb", background: "transparent", color: "#1a1e2e", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Edit</button>
              <button style={{ flex: 1, padding: "8px 0", borderRadius: 6, border: "1px solid #e5e7eb", background: "transparent", color: "#1a1e2e", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Schedule</button>
            </div>
          </div>
        ))}
      </div>
...
function AdminEventsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: "#1a1e2e", margin: 0 }}>Events & Workshops</h1>
        <button style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>
        ...
        <div key={ev.id} style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div>
              ...
              <p style={{ fontSize: 13, color: "#64748b" }}>{formatDateShort(ev.date)} · {ev.type} · {ev.fee === 0 ? "Free" : `$${ev.fee}`}</p>
            </div>
            <div style={{ textAlign: "right" }}>
              <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: T.accent, fontWeight: 700 }}>{ev.registered}</div>
              <p style={{ fontSize: 11, color: "#64748b" }}>of {ev.maxParticipants} spots</p>
            </div>
          </div>
          <div style={{ display: "flex", gap: 6, marginTop: 12 }}>
            <button style={{ flex: 1, padding: "8px 0", borderRadius: 6, border: "1px solid #e5e7eb", background: "transparent", color: "#1a1e2e", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Edit</button>
            <button style={{ flex: 1, padding: "8px 0", borderRadius: 6, border: "1px solid #e5e7eb", background: "transparent", color: "#f87171", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Delete</button>
          </div>
        </div>
      ))}
    </div>
...
function AdminPricingPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: "#1a1e2e", margin: 0 }}>Pricing & Memberships</h1>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: "#ffffff", border: `1px solid ${tier.popular ? T.accent : "#e5e7eb"}`, borderRadius: 12, padding: 18 }}>
            ...
            <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, color: "#1a1e2e", margin: "0 0 4px" }}>{tier.name}</h3>
            <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 34, color: T.accent, fontWeight: 700 }}>${tier.price}<span style={{ fontSize: 14, color: "#64748b", fontWeight: 400 }}> {tier.period}</span></div>
            <p style={{ fontSize: 12, color: "#64748b", margin: "8px 0" }}>{tier.features.length} features</p>
            <div style={{ display: "flex", gap: 6 }}>
              <button style={{ flex: 1, padding: "8px 0", borderRadius: 6, border: "1px solid #e5e7eb", background: "transparent", color: "#1a1e2e", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Edit</button>
              <button style={{ flex: 1, padding: "8px 0", borderRadius: 6, border: "1px solid #e5e7eb", background: "transparent", color: "#f87171", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Delete</button>
            </div>
...
function AdminBroadcastPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: "#1a1e2e", margin: 0 }}>Broadcast & Notifications</h1>
      <div style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <input placeholder="Title" style={{ padding: "10px 14px", background: "#f8f9fb", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1e2e", fontSize: 13, outline: "none" }} />
          <textarea value={message} onChange={e => setMessage(e.target.value)} placeholder="Message..." rows={4} style={{ padding: "10px 14px", background: "#f8f9fb", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1e2e", fontSize: 13, outline: "none", resize: "vertical", fontFamily: "inherit" }} />
          <div style={{ display: "flex", gap: 6 }}>
...
function PageHero({ title, subtitle, image }) {
  return (
    <>
      <div style={{ position: "relative", overflow: "hidden", padding: "28px 20px 16px", minHeight: 220, display: "flex", flexDirection: "column", justifyContent: "flex-end", marginBottom: 16, marginLeft: -16, marginRight: -16 }}>
...
function StatBox({ label, value }) {
  return (
    <div style={{ background: T.bgDim, borderRadius: 10, padding: "12px 14px", textAlign: "center" }}>
      <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, color: T.text }}>{value}</div>
...
function CTACard() {
  ...
  return (
    <div style={{ borderRadius: 14, padding: "22px 20px", color: "#fff", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", top: -20, right: -10, fontSize: 100, opacity: 0.08, lineHeight: 1, zIndex: 1 }}>AH</div>
      <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 24, margin: "0 0 6px", fontWeight: 600, position: "relative", zIndex: 2 }}>New Student Intro</h3>
      <p style={{ fontSize: 13, color: "rgba(255,255,255,.75)", margin: "0 0 14px", maxWidth: 260, position: "relative", zIndex: 2 }}>2 weeks of unlimited classes for just $50. Wood stove heat, eucalyptus towels, and a 100-year-old studio waiting for you.</p>
      <button onClick={() => setPage("membership")} style={{ padding: "10px 24px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontWeight: 700, fontSize: 14, cursor: "pointer", fontFamily: "'Playfair Display', serif", letterSpacing: "0.03em", position: "relative", zIndex: 2 }}>
        Get Started
      </button>
    </div>
  );
...
function AdminSettingsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: "#1a1e2e", margin: 0 }}>Settings</h1>
      <AdminCard title="Studio Information">
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div>
            <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#64748b", marginBottom: 4 }}>Studio Name</label>
            <input type="text" defaultValue="Ashland Hot Yoga" style={{ width: "100%", padding: "10px 14px", background: "#f8f9fb", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1e2e", fontSize: 13, outline: "none" }} />
          </div>
          <div>
            <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#64748b", marginBottom: 4 }}>Address</label>
            <input type="text" defaultValue="2455 Siskiyou Blvd, Ashland, OR 97520" style={{ width: "100%", padding: "10px 14px", background: "#f8f9fb", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1e2e", fontSize: 13, outline: "none" }} />
          </div>
          <div>
            <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#64748b", marginBottom: 4 }}>Phone</label>
            <input type="text" defaultValue="(541) 631-9049" style={{ width: "100%", padding: "10px 14px", background: "#f8f9fb", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1e2e", fontSize: 13, outline: "none" }} />
          </div>
      ...
      <AdminCard title="Membership Settings">
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <p style={{ fontSize: 13, color: "#64748b", margin: 0 }}>Manage membership tiers, pricing, and features from the Pricing page.</p>
          <button style={{ padding: "10px 0", borderRadius: 8, border: "1px solid #e5e7eb", background: "transparent", color: T.accent, fontWeight: 700, fontSize: 14, cursor: "pointer" }}>Go to Pricing</button>
        </div>
      </AdminCard>
    </div>
  );
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: T.bgCard, borderRadius: "20px 20px 0 0", width: "100%", maxWidth: 390, maxHeight: "85vh", overflow: "auto", padding: "20px 20px 40px" }}>
        ...
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 48, height: 48, borderRadius: 12, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Playfair Display', serif", fontSize: 20, color: "#fff", fontWeight: 700 }}>AP</div>
            <div>
              <p style={{ fontWeight: 700, margin: 0, fontSize: 15 }}>Ashley Park</p>
              <p style={{ fontSize: 12, color: T.textMuted, margin: "2px 0 0" }}>Inferno Member · Since Mar 2023</p>
            </div>
          </div>
        </div>
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
        ...
        <div style={{ padding: "14px 0" }}>
          ...
          <p style={{ fontSize: 12, color: T.textFaint, margin: "4px 0 0" }}>Siskiyou Blvd, Ashland · Breathe. Sweat. Flow. — Since 2004 in a 100-Year-Old Building</p>
        </div>
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: T.bgCard, borderRadius: "20px 20px 0 0", width: "100%", maxWidth: 390, padding: "24px 20px 36px" }}>
        {!confirmed ? (
            ...
            <div style={{ background: T.bgDim, borderRadius: 14, padding: "18px 16px", marginBottom: 20 }}>
              ...
              <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <span style={{ fontSize: 14, color: T.text }}>Ashland Hot Yoga · Siskiyou Blvd</span>
                </div>
              </div>
            </div>
            <button onClick={handleConfirm} style={{ width: "100%", padding: "14px 0", borderRadius: 10, border: "none", fontWeight: 700, cursor: "pointer", background: isFull ? T.warning : T.accent, color: "#fff", fontFamily: "'Playfair Display', serif", fontSize: 18, letterSpacing: "0.03em" }}>
          ...
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 26, margin: "0 0 6px", color: T.text }}>You're In!</h2>
            <p style={{ fontSize: 14, color: T.textMuted, margin: "0 0 20px" }}>
              {classData.type} · {fmtTime(classData.time)}<br/>See you in the heat!
            </p>
...
export default function App() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("lumi-open-admin", handler);
    return () => window.removeEventListener("lumi-open-admin", handler);
  }, []);
  ...
  if (isAdmin) {
    return (
      <AppContext.Provider value={{ page, setPage, classRegistrations, registerForClass, openReservation, feedCelebrations, celebrateFeed }}>
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 9999, display: "flex", fontFamily: "'DM Sans', system-ui, sans-serif", background: "#f8f9fb", color: "#1a1e2e", overflow: "hidden" }}>
          <aside style={{ width: 240, background: "#ffffff", borderRight: "1px solid #e5e7eb", display: "flex", flexDirection: "column", height: "100%", zIndex: 20, flexShrink: 0 }}>
            <div style={{ padding: 16, borderBottom: "1px solid #e5e7eb" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <div style={{ width: 38, height: 38, borderRadius: 10, background: T.accent, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, color: "#fff" }}>AH</div>
                <div>
                  <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 18, color: "#1a1e2e", fontWeight: 600, display: "block", lineHeight: 1 }}>ASHLAND</span>
                  <span style={{ fontSize: 9, color: "#64748b", textTransform: "uppercase", letterSpacing: "0.15em" }}>Admin Panel</span>
                </div>
              </div>
            </div>
            <nav style={{ flex: 1, padding: "12px 8px", overflow: "auto" }}>
              <p style={{ fontSize: 10, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em", color: "#64748b", padding: "0 10px", margin: "0 0 8px" }}>Management</p>
              {adminTabs.map(tab => {
                const active = page === tab.id;
                return (
                  <button key={tab.id} onClick={() => setPage(tab.id)} style={{ display: "flex", alignItems: "center", gap: 10, width: "100%", padding: "10px 12px", borderRadius: 8, border: "none", background: active ? T.accent : "transparent", color: active ? "#fff" : "#4b5563", fontSize: 13, fontWeight: active ? 600 : 400, cursor: "pointer", marginBottom: 2, textAlign: "left" }}>
                    <tab.icon size={18} />
                    <span>{tab.label}</span>
            ...
            <div style={{ borderTop: "1px solid #e5e7eb", padding: "10px 8px" }}>
              <button onClick={() => { setIsAdmin(false); setPage("home"); }} style={{ display: "flex", alignItems: "center", gap: 10, width: "100%", padding: "10px 12px", borderRadius: 8, border: "none", background: "transparent", color: "#4b5563", fontSize: 13, cursor: "pointer", textAlign: "left" }}>
                <LogOut size={18} />
  ...
  return (
    <AppContext.Provider value={{ page, setPage, classRegistrations, registerForClass, openReservation, feedCelebrations, celebrateFeed }}>
      ...
      <div style={{ maxWidth: 390, margin: "0 auto", minHeight: "100vh", background: T.bgDim, fontFamily: "'DM Sans', system-ui, sans-serif", position: "relative" }}>
        ...
        {/* Content */}
        <main ref={contentRef} style={{ paddingBottom: 60 }}>
          {renderPage()}
        </main>
